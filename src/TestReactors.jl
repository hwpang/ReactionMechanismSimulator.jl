...
@test s == "Analyzing ethane sensitivity to HO2+ethane<=>H2O2+C2H5 at a value of -0.037981415082408904 \n\nKey branching for HO2 \nHO2+HO2<=>O2+H2O2 had a branching ratio of 0.6323575668571353 \nHO2+ethane<=>H2O2+C2H5 had a branching ratio of 0.3584435897104919 \n\nKey branching for ethane \nOH+ethane<=>H2O+C2H5 had a branching ratio of 0.5761454212665097 \nHO2+ethane<=>H2O2+C2H5 had a branching ratio of 0.32806808951946903 \nH+ethane<=>H2+C2H5 had a branching ratio of 0.03139887356375256 \nO2+ethane<=>HO2+C2H5 had a branching ratio of 0.02914536094381157 \nCH3+CH3<=>ethane had a branching ratio of 0.016514678049585597 \nCH3+ethane<=>CH4+C2H5 had a branching ratio of 0.014533399296268951 \n\nAssociated key reaction path in ethane loss direction \nHO2+ethane<=>H2O2+C2H5 at path branching of 0.32806808951946903 \nHO2+C2H4<=>O2+C2H5 at path branching of 0.9193407690555341 \n\nAssociated key reaction path in ethane loss direction \nHO2+ethane<=>H2O2+C2H5 at path branching of 0.32806808951946903 \nHO2+C2H4<=>O2+C2H5 at path branching of 0.9193407690555341 \n\nAssociated key reaction path in ethane loss direction \nHO2+ethane<=>H2O2+C2H5 at path branching of 0.32806808951946903 \nHO2+C2H4<=>O2+C2H5 at path branching of 0.9193407690555341 \n\n\n"
end;
