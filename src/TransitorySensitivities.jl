...
timescales are grained multiplicativly with taumax,taumin, with taures being the
...
function transitorysensitivitiesadjointexact(sim::Simulation,t,name;tau=NaN,
    ...
    if tau == 0.0
        ...
        simadj = Simulation(soladj,domain);
...
export transitorysensitivitiesadjointapprox
